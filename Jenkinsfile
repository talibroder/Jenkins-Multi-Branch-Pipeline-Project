pipeline {
	...
	steps {
	script {
	sh "scp -i /home/tali/talibroder.pem nginx.conf ubuntu@51.20.233.205:/home/ubuntu"
        sh "scp -i /home/tali/talibroder.pem docker-compose.yaml ubuntu@51.20.233.205:/home/ubuntu"
